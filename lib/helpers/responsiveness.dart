...
class ResponsiveWidget extends StatelessWidget {
  ...
  const ResponsiveWidget({Key? key, required this.largeScreen, this.mediumScreen, required this.smallScreen, this.customScreen}) : super(key: key);
  ...
  //isCustomScreen
  static bool isCustomScreen(BuildContext context) => MediaQuery.of(context).size.width >= mediumScreenSize &&
